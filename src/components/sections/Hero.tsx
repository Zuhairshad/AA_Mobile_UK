  ...
  return (
    <section className="relative overflow-hidden">
      <div className="content-boundary">
        <div className="rails relative">
          <span className="rail-ticks" aria-hidden="true" />

          <div className="mx-auto flex max-w-4xl flex-col items-center gap-6 px-4 py-16 text-center md:gap-8 md:py-24">
          ...
          <dl className="grid grid-cols-2 border-t border-line md:grid-cols-4">
            {proof.map((item, i) => (
              ...
              >
                ...
                <dt className="micro-label order-2 text-center">
                  {item.label}
                </dt>
